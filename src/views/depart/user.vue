<template>
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button size="mini" class="btn-add" @click="handleAdd()" style="margin-left: 20px">添加资产负责人</el-button>
    </el-card>
...
<script>
  import {fetchUser5,createUser5,updateUser5,deleteUser} from '@/api/root_user';
  ...
  export default {
    ...
    created(){
      ...
      this.listQuery.sectname = store.getters.sectname;
      this.getList();
    },
    methods: {
      ...
      getList(){
        ...
        fetchUser5(this.listQuery).then(response =>{
